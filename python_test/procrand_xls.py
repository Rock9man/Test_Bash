...
heads = ['totle', 'Android', 'gaode', 'kuwo', 'xinwen', 'gupiao','tianqi','ximalaya', 'weixin', 'iAuto']
...
def main(argv):
	...
	i = 0
	for line in lines1:
		datamap.setdefault(str(line),[]).append(str(lines2[i]))
		i = i + 1
		...
		for line in lines:
			...
			if "cmdline" not in line:
				if len(data) == 6 :
					...
					newsheet.write(15 + i,int(j+2),datamap.get(data[5]))
					sumlist[0] = int(sumlist[0]) + int(data[3][:-1])
					if datamap.get(data[5])[0] in "Android":
						sumlist[1] = int(sumlist[1]) + int(data[3][:-1])
					elif datamap.get(data[5])[0] in "gaode":
						sumlist[2] = int(sumlist[2]) + int(data[3][:-1])
					elif datamap.get(data[5])[0] in "kuwo":
						sumlist[3] = int(sumlist[3]) + int(data[3][:-1])
					elif datamap.get(data[5])[0] in "xinwen":
						sumlist[4] = int(sumlist[4]) + int(data[3][:-1])
					elif datamap.get(data[5])[0] in "gupiao":
						sumlist[5] = int(sumlist[5]) + int(data[3][:-1])
					elif datamap.get(data[5])[0] in "tianqi":
						sumlist[6] = int(sumlist[6]) + int(data[3][:-1])
					elif datamap.get(data[5])[0] in "ximalaya":
						sumlist[7] = int(sumlist[7]) + int(data[3][:-1])
					elif datamap.get(data[5])[0] in "weixin":
						sumlist[8] = int(sumlist[8]) + int(data[3][:-1])
					elif datamap.get(data[5])[0] in "iAuto":
